...
//     DateTime? creationDate = context.select<PhotoData, TagInfo>((data) => data.old_tags).creationDate;
//     if (creationDate == null) {
//       context.select<PhotoData, TagInfo>((data) => data.data).creationDate = selectedDate;
